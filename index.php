<html>
   <head>
      <title>Generate Drag Item Images</title>
   </head>
   <body>
      <style type="text/css">
      <!--
      ...
      <div class='left'>
         <div class='left-top'>
            ...
            <div class='output-image'>
               ...
               <div>First File Index <input class='small' type='text' name='imagefilestart' maxlength='4' value='1' /></div>
               <div>File Name <input class='large' type='text' name='imagefilename' maxlength='256' value="itemsprites_{FILENUM}" /></div>
               <div>
               File Type
            ...
            <div class='output-css'>
               <h2>Output CSS</h2>
               <div>Icon Number Start <input class='small' type='text' name='iconstart' maxlength='4' value='500' /></div>
               <div>
                  Template <input type='text' class='extralarge' name='csstemplate' maxlength='256' value=".icon-{ICON} { background: url('../icons/{FILE}') {X}px {Y}px; }" />
               </div>
               <div>Filename <input class='large' type='text' name='cssfilename' maxlength='50' value='icons.css' /></div>
            </div>
            <div class='buttonrow'>
