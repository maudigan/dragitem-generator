This will convert the native dds dragitem files from everquest into PNG, GIF or JPEG images
...
Put all your dragitem*.dds files into the dragitem directory, then run the index.php file.
